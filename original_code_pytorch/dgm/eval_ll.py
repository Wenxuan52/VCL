...
from alg.eval_test_ll import IS_estimate
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--chunk_k", type=int, default=100)
...
def _generate_single_preview_row(
    ...
    for i in seen_tasks:
        ...
        x = decoder(z, task_id=i, sample_W=sample_W)
        row[i] = x[0].detach().cpu().numpy()
    return row
